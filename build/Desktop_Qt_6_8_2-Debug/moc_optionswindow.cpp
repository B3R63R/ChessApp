...
namespace {
struct qt_meta_tag_ZN13OptionsWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13OptionsWindowE = QtMocHelpers::stringData(
    "OptionsWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13OptionsWindowE[] = {
...
Q_CONSTINIT const QMetaObject OptionsWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13OptionsWindowE.offsetsAndSizes,
    qt_meta_data_ZN13OptionsWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13OptionsWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *OptionsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13OptionsWindowE.stringdata0))
